...
Step 1: Download this application from GitHub by using below command are use tortoisegit git clone https://github.com/spring-guides/gs-testing-web.git 
...
POST: http://localhost:9999/assignment/api/ddPerson 
...
PUT: http://localhost:9999/assignment/api/editPerson/{id} {"firstName":"Simhachalam_1","lastName":"Pydana_1"}
